...
(function($) {
	...
	function docForm() {
		alert("docForm has been moved to vendor/couchapp/lib/docForm.js, use app.require to load")
	}
	...
	function makeRequire(ddoc) {
		...
		var require = function (name, parents) {
			...
			try {
				eval(s);
				func.apply(ddoc, [exports, function(name) {
					return require(name, parents)
				}]);
			} catch(e) {
